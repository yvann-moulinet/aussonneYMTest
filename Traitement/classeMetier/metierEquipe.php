...
Class metierEquipe
	...
	public function __get($attribut)
		{	switch ($attribut)
			{	case 'idEquipe' :
				...
				case 'idSpecialite' :
					return $this->lSpecialite->idSpecialite; break;
				case 'nomSpecialite' :
					return $this->lSpecialite->nomSpecialite; break;
				default :
	...
	public function __set($attribut, $laValeurDeLAttribut)
		{	switch($attribut)
			{	case 'idEquipe' :
				...
				case 'idSpecialite' :
					$this->idSpecialite=$laValeurDeLAttribut; break;
				case 'nomSpecialite' :
					$this->nomSpecialite=$laValeurDeLAttribut; break;
				default :
                    $trace = debug_backtrace();
                    trigger_error('Propriété non-accessible via _get() :'.$attribut.'dans '.$trace[0]['file'].' à la ligne'.$trace[0]['line'],E_USER_NOTICE);
				    break;
	...
	{
		return $liste=$this->nomEquipe.'|'.$this->lSpecialite->nomSpecialite.'|';
